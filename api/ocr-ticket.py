...
- ESCRITURA LATINA OBLIGATORIA en proveedor y concepto: NEVER return Chinese/Japanese/Korean/Thai/Arabic/Cyrillic characters in ANY text field — el reporte de gastos se entrega a contabilidad mexicana. Si el recibo esta en otro alfabeto: traduce al espanol las palabras descriptivas (restaurante, hotel, comercio) y romaniza los nombres propios (pinyin para chino, romaji para japones). Ejemplos reales:
  - "东莞市厚街冠金餐饮店（个体工商户）" → proveedor="Restaurante Guanjin Houjie (Dongguan)"
  - "商户-张世典" → proveedor="Comercio Zhang Shidian"
  - concepto "商户消费" → concepto="Consumo en comercio"
  - Un konbini japones "セブン-イレブン" → proveedor="7-Eleven"
