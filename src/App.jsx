...
const COLABORADORES_ESPECIALES = ['Alejandro Olivar', 'Victor Aceves']
    ...
    <div className="app">
      ...
      <div className="header">
        ...
        <div className="header-info">
          <h1 className="header-title">Reporte de Gastos SMTO<span className="version-badge">v7.22</span></h1>
