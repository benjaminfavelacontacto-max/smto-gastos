...
const getTiposForColaborador = (colaborador) => {
  ...
  const cat = colaborador.categoria
  if (cat === 'Ventas' || cat === 'Socio') {
    // David Delgado (Socio) además necesita 'Pasaporte o Visa' en su lista.
    if (colaborador.nombre === 'David Delgado') return [...TIPOS_VENTAS, 'Pasaporte o Visa']
    return TIPOS_VENTAS
  }
    ...
    <div className="app">
      ...
      <div className="header">
        ...
        <div className="header-info">
          <h1 className="header-title">Reporte de Gastos SMTO<span className="version-badge">v8.43</span></h1>
